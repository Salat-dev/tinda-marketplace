...
<script src="js/ux-animations.js"></script>
    ...
    <meta name="description" content="Découvrez tous les produits de cette catégorie sur Tinda." />
    ...
    <style>
        /* ══════════════════════════════════════════════════════════
           DESIGN SYSTEM (identique à shop.html)
        ══════════════════════════════════════════════════════════ */
        :root {
            --color-bg: #FFFFFF;
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .category-hero {
            ...
            border-bottom: 1px solid var(--color-border-light);
            padding: var(--space-xl) max(48px, env(safe-area-inset-left));
            text-align: center;
        }
        ...
        .mi-card:hover .mi-card__media img { transform: scale(1.06); }
        .mi-card__wish {
            position: absolute;
            top: 12px;
            right: 12px;
        ...
        .mi-card:hover .mi-card__wish { opacity: 1; }
        .mi-card__wish:hover { color: #FF3B30; transform: scale(1.1); }
        .mi-card__atc {
            position: absolute;
            bottom: 0;
            left: 0;
        ...
        .mi-card:hover .mi-card__atc {
            opacity: 1;
            transform: translateY(0);
        }
        .mi-card__atc:hover { background: var(--color-accent); }
        .mi-card__body {
        ...
        .badge--new { background: var(--color-text); color: white; }
        .badge--bestseller { background: var(--color-accent); color: white; }
        .badge--featured { background: var(--color-accent); color: white; }
        .badge--promo { background: var(--color-text); color: white; }
        .badge--out_of_stock { background: var(--color-text-tertiary); color: white; }
...
<body>
    ...
    <section class="category-hero" id="categoryHero">
        <h1 class="category-hero__title" id="catTitle">Catégorie</h1>
        <p class="category-hero__count" id="catCount">Chargement...</p>
    </section>
   ...
   <footer class="footer">
        ...
        <div class="footer__bottom"><p>© 2025 Tinda — Marketplace africaine de confiance.</p><div class="footer__payment"><span class="footer__payment-badge">MTN MoMo</span><span class="footer__payment-badge">Orange Money</span><span class="footer__payment-badge">Paiement cash</span></div></div>
    </footer>
    <!-- TOAST CONTAINER -->
    ...
    <script>
        ...
        const Cart = {
            ...
            add(product, qty=1) {
                ...
                if (ex) { ex.qty += qty; }
                else { cart.push({ _key: key, id: product.id, vendor_id: product.vendor_id||null, vendor: product.vendors?.shop_name||'Tindamba', name: product.name, price: product.price, image: (Array.isArray(product.images)&&product.images[0])||product.image_url||'', color: null, qty }); }
                this.save(cart);
